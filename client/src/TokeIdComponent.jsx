import { Card, Col, Image, Row, Typography, Button, Divider } from 'antd';
            ...
            <Row>
                ...
                <Col xs={24} sm={24} md={12} lg={12} className="p-1">
                    <Card loading={loading} >
                        ...
                        <Divider />
                        {
                            (zoraData.type === "audio" && loading === false) ? <audio controls className='w-full'>
                                ...
                                : <Row>
                                    <Col span={24}>
                                        {
                                            zoraData.type === "video" ? <Button type='primary' href={zoraData.contentURI} target="_blank">Open Video</Button> : <audio controls className='w-full'>
                                                <source src={zoraData.contentURI} type="audio/ogg" />
                                                <source src={zoraData.contentURI} type="audio/mpeg" />
                                                Your browser does not support the audio element.
                                            </audio>
